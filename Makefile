...
ifeq ($(HAS_EASK),yes)
	...
	$(EMACS) --batch -L . -f batch-byte-compile workset.el workset-project.el workset-worktree.el workset-terminal.el workset-notify.el
endif
...
ifeq ($(HAS_EASK),yes)
	...
	$(EMACS) --batch -L . -f checkdoc-file workset-terminal.el workset-notify.el
endif
